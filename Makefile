...
INCLUDES = include/
EXEC = k_means
CFLAGS = -O2 -ffast-math -ftree-vectorize -march=native -fopt-info-vec-optimized #-funroll-loops#-fopt-info-vec-missed#-fopt-info-vec-optimized -ftree-vectorizer-verbose=2 #-ffast-math -msse4 -march=native
